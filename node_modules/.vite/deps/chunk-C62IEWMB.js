...
var name, shader, sharpenPixelShader;
var init_sharpen_fragment = __esm({
  "node_modules/@babylonjs/core/Shaders/sharpen.fragment.js"() {
    init_shaderStore();
    name = "sharpenPixelShader";
    shader = `varying vec2 vUV;uniform sampler2D textureSampler;uniform vec2 screenSize;uniform vec2 sharpnessAmounts;
...
color*4.0;gl_FragColor=max(vec4(color.rgb*sharpnessAmounts.y,color.a)-(sharpnessAmounts.x*vec4(edgeDetection.rgb,0)),0.);}`;
    ...
    sharpenPixelShader = { name, shader };
  }
});
...
//# sourceMappingURL=chunk-C62IEWMB.js.map
