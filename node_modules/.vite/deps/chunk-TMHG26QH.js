...
var init_transformNode = __esm({
  "node_modules/@babylonjs/core/Meshes/transformNode.js"() {
    ...
    init_node();
    init_typeStore();
    TransformNode = class _TransformNode extends Node {
      /**
...
var init_abstractMesh = __esm({
  "node_modules/@babylonjs/core/Meshes/abstractMesh.js"() {
    ...
    AbstractMesh = class _AbstractMesh extends TransformNode {
      /**
       * No billboard
       */
      ...
      async optimizeIndicesAsync() {
        ...
        const { OptimizeIndices } = await import("./mesh.vertexData.functions-J75KXGFJ.js");
...
//# sourceMappingURL=chunk-TMHG26QH.js.map
