...
var name, shader, volumetricLightingRenderVolumePixelShader;
var init_volumetricLightingRenderVolume_fragment = __esm({
  "node_modules/@babylonjs/core/Shaders/volumetricLightingRenderVolume.fragment.js"() {
    init_shaderStore();
    init_sceneFragmentDeclaration();
    init_sceneUboDeclaration();
    name = "volumetricLightingRenderVolumePixelShader";
    shader = `#include<__decl__sceneFragment>
...
`;
    ...
    volumetricLightingRenderVolumePixelShader = { name, shader };
  }
});
init_volumetricLightingRenderVolume_fragment();
export {
  volumetricLightingRenderVolumePixelShader
};
//# sourceMappingURL=volumetricLightingRenderVolume.fragment-SNZM4YTJ.js.map
