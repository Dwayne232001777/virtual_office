    ...
    RenderTargetTexture = class _RenderTargetTexture extends Texture {
      ...
      isReadyForRendering() {
        if (!this._dumpToolsLoading) {
          ...
          import("./dumpTools-KRKV5NP7.js").then((module) => this._dumpTools = module);
        }
    ...
    PostProcess = class _PostProcess {
      ...
      _gatherImports(useWebGPU = false, list) {
        if (useWebGPU && this._webGPUReady) {
          list.push(Promise.all([import("./postprocess.vertex-3MN3XYIG.js")]));
        } else {
          list.push(Promise.all([import("./postprocess.vertex-3RD6UHDR.js")]));
        }
      }
      /**
...
function _GetCompatibleTextureLoader(extension, mimeType) {
  ...
  if (!RegisteredTextureLoaders.has(extension)) {
    if (extension.endsWith(".ies")) {
      registerTextureLoader(".ies", async () => await import("./iesTextureLoader-ZOOZ7YHX.js").then((module) => new module._IESTextureLoader()));
    }
    if (extension.endsWith(".dds")) {
      registerTextureLoader(".dds", async () => await import("./ddsTextureLoader-UZ6H6EO5.js").then((module) => new module._DDSTextureLoader()));
    }
    if (extension.endsWith(".basis")) {
      registerTextureLoader(".basis", async () => await import("./basisTextureLoader-XBYWZWOP.js").then((module) => new module._BasisTextureLoader()));
    }
    if (extension.endsWith(".env")) {
      registerTextureLoader(".env", async () => await import("./envTextureLoader-3Y2IR3UW.js").then((module) => new module._ENVTextureLoader()));
    }
    if (extension.endsWith(".hdr")) {
      registerTextureLoader(".hdr", async () => await import("./hdrTextureLoader-SIGIC35P.js").then((module) => new module._HDRTextureLoader()));
    }
    if (extension.endsWith(".ktx") || extension.endsWith(".ktx2")) {
      registerTextureLoader(".ktx", async () => await import("./ktxTextureLoader-YNBOTLJA.js").then((module) => new module._KTXTextureLoader()));
      registerTextureLoader(".ktx2", async () => await import("./ktxTextureLoader-YNBOTLJA.js").then((module) => new module._KTXTextureLoader()));
    }
    if (extension.endsWith(".tga")) {
      registerTextureLoader(".tga", async () => await import("./tgaTextureLoader-FYZ5QW7Q.js").then((module) => new module._TGATextureLoader()));
    }
    if (extension.endsWith(".exr")) {
      registerTextureLoader(".exr", async () => await import("./exrTextureLoader-DPGCRSAQ.js").then((module) => new module._ExrTextureLoader()));
    }
  }
  ...
  "node_modules/@babylonjs/core/Engines/Extensions/engine.prefilteredCubeTexture.js"() {
    ...
    ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
      const callbackAsync = async (loadData) => {
        ...
        const { DDSTools } = await import("./dds-XMFU6CJJ.js");
        const textures = [];
...
var init_abstractEngine_loadFile = __esm({
  "node_modules/@babylonjs/core/Engines/AbstractEngine/abstractEngine.loadFile.js"() {
    init_abstractEngine();
...
var init_abstractEngine_textureLoaders = __esm({
  "node_modules/@babylonjs/core/Engines/AbstractEngine/abstractEngine.textureLoaders.js"() {
  ...
  "node_modules/@babylonjs/core/PostProcesses/thinPassPostProcess.js"() {
    ...
    ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
      _gatherImports(useWebGPU, list) {
        if (useWebGPU) {
          ...
          list.push(Promise.all([import("./pass.fragment-UECRJZSP.js")]));
        } else {
          list.push(Promise.all([import("./pass.fragment-GQ4PNZOK.js")]));
        }
    ...
    ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
      _gatherImports(useWebGPU, list) {
        if (useWebGPU) {
          this._webGPUReady = true;
          list.push(Promise.all([import("./passCube.fragment-6LYV4VEZ.js")]));
        } else {
          list.push(Promise.all([import("./passCube.fragment-PBHKB7EF.js")]));
        }
        super._gatherImports(useWebGPU, list);
      }
      /**
...
async function ReadPixelsUsingRTT(texture, width, height, face, lod) {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      await import("./lodCube.fragment-6NNP27T5.js");
    } else {
      await import("./lod.fragment-EPVPONYI.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-4ACNUZT6.js");
    } else {
      await import("./lod.fragment-GHFRGYEU.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-E2UXTG46.js.map
