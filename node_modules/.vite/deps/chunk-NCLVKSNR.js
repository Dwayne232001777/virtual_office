...
var name, shader, iblVoxelSlabDebugPixelShaderWGSL;
var init_iblVoxelSlabDebug_fragment = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/iblVoxelSlabDebug.fragment.js"() {
    init_shaderStore();
    name = "iblVoxelSlabDebugPixelShader";
    shader = `varying vNormalizedPosition: vec3f;uniform nearPlane: f32;uniform farPlane: f32;uniform stepSize: f32;@fragment
...
normPos.x>1.0 || normPos.y>1.0 || normPos.z>1.0) {fragmentOutputs.color= vec4f(0.0,0.0,0.0,0.0);} else {fragmentOutputs.color= vec4f(slab,0.0,0.0,0.75);}}`;
    ...
    iblVoxelSlabDebugPixelShaderWGSL = { name, shader };
  }
});
...
//# sourceMappingURL=chunk-NCLVKSNR.js.map
