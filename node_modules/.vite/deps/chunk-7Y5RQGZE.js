...
var init_uvVariableDeclaration = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/uvVariableDeclaration.js"() {
    init_shaderStore();
    name5 = "uvVariableDeclaration";
    shader5 = `#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
...
var init_samplerVertexImplementation = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/samplerVertexImplementation.js"() {
    init_shaderStore();
    name6 = "samplerVertexImplementation";
    shader6 = `#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
if (v_INFONAME_==0.)
...
//# sourceMappingURL=chunk-7Y5RQGZE.js.map
