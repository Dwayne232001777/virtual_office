...
var name, shader;
var init_openpbrFragmentDeclaration = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrFragmentDeclaration.js"() {
    init_shaderStore();
    init_sceneFragmentDeclaration();
    init_decalFragmentDeclaration();
    name = "openpbrFragmentDeclaration";
...
var init_openpbrFragmentSamplersDeclaration = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrFragmentSamplersDeclaration.js"() {
    init_shaderStore();
    init_samplerFragmentDeclaration();
    name2 = "openpbrFragmentSamplersDeclaration";
    shader2 = `#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
var init_openpbrNormalMapFragmentMainFunctions = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrNormalMapFragmentMainFunctions.js"() {
    init_shaderStore();
    name3 = "openpbrNormalMapFragmentMainFunctions";
    shader3 = `#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
var init_openpbrNormalMapFragmentFunctions = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrNormalMapFragmentFunctions.js"() {
    init_shaderStore();
    init_samplerFragmentDeclaration();
    name4 = "openpbrNormalMapFragmentFunctions";
    shader4 = `#if defined(GEOMETRY_NORMAL)
...
var init_openpbrDielectricReflectance = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrDielectricReflectance.js"() {
    init_shaderStore();
    name5 = "openpbrDielectricReflectance";
    shader5 = `struct ReflectanceParams
...
var init_openpbrConductorReflectance = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrConductorReflectance.js"() {
    init_shaderStore();
    name6 = "openpbrConductorReflectance";
    shader6 = `#define pbr_inline
...
var init_openpbrAmbientOcclusionFunctions = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrAmbientOcclusionFunctions.js"() {
    init_shaderStore();
    name7 = "openpbrAmbientOcclusionFunctions";
    shader7 = `float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
var init_openpbrGeometryInfo = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrGeometryInfo.js"() {
    init_shaderStore();
    name8 = "openpbrGeometryInfo";
    shader8 = `struct geometryInfoOutParams
...
var init_openpbrIblFunctions = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrIblFunctions.js"() {
    init_shaderStore();
    name9 = "openpbrIblFunctions";
    shader9 = `#ifdef REFLECTION
...
var init_openpbrNormalMapFragment = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrNormalMapFragment.js"() {
    init_shaderStore();
    name10 = "openpbrNormalMapFragment";
    shader10 = `vec2 uvOffset=vec2(0.0,0.0);
...
var init_openpbrBlockNormalFinal = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrBlockNormalFinal.js"() {
    init_shaderStore();
    name11 = "openpbrBlockNormalFinal";
    shader11 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
var init_openpbrBaseLayerData = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrBaseLayerData.js"() {
    init_shaderStore();
    name12 = "openpbrBaseLayerData";
    shader12 = `vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
var init_openpbrCoatLayerData = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrCoatLayerData.js"() {
    init_shaderStore();
    name14 = "openpbrCoatLayerData";
    shader14 = `float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
var init_openpbrThinFilmLayerData = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrThinFilmLayerData.js"() {
    init_shaderStore();
    name15 = "openpbrThinFilmLayerData";
    shader15 = `#ifdef THIN_FILM
...
var init_openpbrFuzzLayerData = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrFuzzLayerData.js"() {
    init_shaderStore();
    name16 = "openpbrFuzzLayerData";
    shader16 = `float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
var init_openpbrAmbientOcclusionData = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrAmbientOcclusionData.js"() {
    init_shaderStore();
    name17 = "openpbrAmbientOcclusionData";
    shader17 = `vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
var init_openpbrBackgroundTransmission = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrBackgroundTransmission.js"() {
    init_shaderStore();
    name18 = "openpbrBackgroundTransmission";
    shader18 = `vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
var init_openpbrEnvironmentLighting = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrEnvironmentLighting.js"() {
    init_shaderStore();
    name19 = "openpbrEnvironmentLighting";
    shader19 = `#ifdef REFLECTION
#ifdef FUZZ
...
var init_openpbrDirectLightingInit = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrDirectLightingInit.js"() {
    init_shaderStore();
    name20 = "openpbrDirectLightingInit";
...
var init_openpbrDirectLighting = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrDirectLighting.js"() {
    init_shaderStore();
    name21 = "openpbrDirectLighting";
    shader21 = `#ifdef LIGHT{X}
...
var name22, shader22, openpbrPixelShader;
var init_openpbr_fragment = __esm({
  "node_modules/@babylonjs/core/Shaders/openpbr.fragment.js"() {
    init_shaderStore();
    init_prePassDeclaration();
    init_oitDeclaration();
    init_openpbrFragmentDeclaration();
    init_openpbrUboDeclaration();
    init_pbrFragmentExtraDeclaration();
    init_lightFragmentDeclaration();
    init_lightUboDeclaration();
    ...
    init_oitFragment();
    init_pbrDebug();
    name22 = "openpbrPixelShader";
    shader22 = `#define OPENPBR_FRAGMENT_SHADER
...
`;
    ...
    openpbrPixelShader = { name: name22, shader: shader22 };
  }
});
...
//# sourceMappingURL=chunk-H46B2T5M.js.map
