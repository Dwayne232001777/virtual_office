...
var name, shader, glowMapGenerationPixelShaderWGSL;
var init_glowMapGeneration_fragment = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/glowMapGeneration.fragment.js"() {
    ...
    init_clipPlaneFragmentDeclaration();
    init_clipPlaneFragment();
    name = "glowMapGenerationPixelShader";
    shader = `#if defined(DIFFUSE_ISLINEAR) || defined(EMISSIVE_ISLINEAR)
...
`;
    ...
    glowMapGenerationPixelShaderWGSL = { name, shader };
  }
});

export {
  glowMapGenerationPixelShaderWGSL,
  init_glowMapGeneration_fragment
};
//# sourceMappingURL=chunk-WBACLTNF.js.map
