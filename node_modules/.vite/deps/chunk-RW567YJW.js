import {
  init_openpbrUboDeclaration
} from "./chunk-J7AMK625.js";
import {
...
var name, shader;
var init_openpbrFragmentSamplersDeclaration = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrFragmentSamplersDeclaration.js"() {
    init_shaderStore();
    init_samplerFragmentDeclaration();
    name = "openpbrFragmentSamplersDeclaration";
    shader = `#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
var name2, shader2;
var init_openpbrNormalMapFragmentMainFunctions = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrNormalMapFragmentMainFunctions.js"() {
    init_shaderStore();
    name2 = "openpbrNormalMapFragmentMainFunctions";
    shader2 = `#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
var name3, shader3;
var init_openpbrNormalMapFragmentFunctions = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrNormalMapFragmentFunctions.js"() {
    init_shaderStore();
    init_samplerFragmentDeclaration();
    name3 = "openpbrNormalMapFragmentFunctions";
    shader3 = `#if defined(GEOMETRY_NORMAL)
...
var init_openpbrDielectricReflectance = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrDielectricReflectance.js"() {
    init_shaderStore();
    name4 = "openpbrDielectricReflectance";
    shader4 = `struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
var name5, shader5;
var init_openpbrConductorReflectance = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrConductorReflectance.js"() {
    init_shaderStore();
    name5 = "openpbrConductorReflectance";
    shader5 = `#define pbr_inline
...
var name6, shader6;
var init_openpbrAmbientOcclusionFunctions = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrAmbientOcclusionFunctions.js"() {
    init_shaderStore();
    name6 = "openpbrAmbientOcclusionFunctions";
    shader6 = `fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
var init_openpbrGeometryInfo = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrGeometryInfo.js"() {
    init_shaderStore();
    name7 = "openpbrGeometryInfo";
    shader7 = `struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
var init_openpbrIblFunctions = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrIblFunctions.js"() {
    init_shaderStore();
    name8 = "openpbrIblFunctions";
    shader8 = `#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
var name9, shader9;
var init_openpbrNormalMapFragment = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrNormalMapFragment.js"() {
    init_shaderStore();
    name9 = "openpbrNormalMapFragment";
    shader9 = `var uvOffset: vec2f= vec2f(0.0,0.0);
...
var name10, shader10;
var init_openpbrBlockNormalFinal = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrBlockNormalFinal.js"() {
    init_shaderStore();
    name10 = "openpbrBlockNormalFinal";
    shader10 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
var name11, shader11;
var init_openpbrBaseLayerData = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrBaseLayerData.js"() {
    init_shaderStore();
    name11 = "openpbrBaseLayerData";
    shader11 = `var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
var name13, shader13;
var init_openpbrCoatLayerData = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrCoatLayerData.js"() {
    init_shaderStore();
    name13 = "openpbrCoatLayerData";
    shader13 = `var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
var name14, shader14;
var init_openpbrThinFilmLayerData = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrThinFilmLayerData.js"() {
    init_shaderStore();
    name14 = "openpbrThinFilmLayerData";
    shader14 = `#ifdef THIN_FILM
...
var name15, shader15;
var init_openpbrFuzzLayerData = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrFuzzLayerData.js"() {
    init_shaderStore();
    name15 = "openpbrFuzzLayerData";
    shader15 = `var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
var name16, shader16;
var init_openpbrAmbientOcclusionData = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrAmbientOcclusionData.js"() {
    init_shaderStore();
    name16 = "openpbrAmbientOcclusionData";
    shader16 = `var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
var name17, shader17;
var init_openpbrBackgroundTransmission = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrBackgroundTransmission.js"() {
    init_shaderStore();
    name17 = "openpbrBackgroundTransmission";
    shader17 = `var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
var name18, shader18;
var init_openpbrEnvironmentLighting = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrEnvironmentLighting.js"() {
    init_shaderStore();
    name18 = "openpbrEnvironmentLighting";
    shader18 = `#ifdef REFLECTION
#ifdef FUZZ
...
var name19, shader19;
var init_openpbrDirectLightingInit = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrDirectLightingInit.js"() {
    init_shaderStore();
    name19 = "openpbrDirectLightingInit";
    shader19 = `#ifdef LIGHT{X}
...
var name20, shader20;
var init_openpbrDirectLighting = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/openpbrDirectLighting.js"() {
    init_shaderStore();
    name20 = "openpbrDirectLighting";
...
var name21, shader21, openpbrPixelShaderWGSL;
var init_openpbr_fragment = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/openpbr.fragment.js"() {
    init_shaderStore();
    init_prePassDeclaration();
    init_oitDeclaration();
    ...
    init_pbrFragmentExtraDeclaration();
    init_lightUboDeclaration();
    init_openpbrFragmentSamplersDeclaration();
    init_imageProcessingDeclaration();
    init_clipPlaneFragmentDeclaration();
    init_logDepthDeclaration();
    init_fogFragmentDeclaration();
    ...
    init_pbrDirectLightingFunctions();
    init_pbrIBLFunctions();
    init_openpbrNormalMapFragmentMainFunctions();
    init_openpbrNormalMapFragmentFunctions();
    init_reflectionFunction();
    init_openpbrDielectricReflectance();
    init_openpbrConductorReflectance();
    init_openpbrAmbientOcclusionFunctions();
    init_openpbrGeometryInfo();
    init_openpbrIblFunctions();
    init_clipPlaneFragment();
    init_pbrBlockNormalGeometric();
    init_openpbrNormalMapFragment();
    init_openpbrBlockNormalFinal();
    init_openpbrBaseLayerData();
    init_openpbrTransmissionLayerData();
    init_openpbrCoatLayerData();
    init_openpbrThinFilmLayerData();
    init_openpbrFuzzLayerData();
    init_openpbrAmbientOcclusionData();
    init_depthPrePass();
    init_openpbrBackgroundTransmission();
    init_openpbrEnvironmentLighting();
    init_openpbrDirectLightingInit();
    init_openpbrDirectLighting();
    init_logDepthFragment();
    init_fogFragment();
    init_pbrBlockImageProcessing();
    init_pbrBlockPrePass();
    init_oitFragment();
    init_pbrDebug();
    name21 = "openpbrPixelShader";
    shader21 = `#define OPENPBR_FRAGMENT_SHADER
...
`;
    ...
    openpbrPixelShaderWGSL = { name: name21, shader: shader21 };
  }
});

export {
  openpbrPixelShaderWGSL,
  init_openpbr_fragment
};
//# sourceMappingURL=chunk-RW567YJW.js.map
