...
} from "./chunk-3A3RDOQT.js";
import {
  init_bumpFragmentFunctions
} from "./chunk-DZQJ4XKI.js";
import {
...
var init_pbrBlockAlbedoOpacity = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockAlbedoOpacity.js"() {
    init_shaderStore();
    init_decalFragment();
    name4 = "pbrBlockAlbedoOpacity";
    shader4 = `struct albedoOpacityOutParams
...
var init_pbrBlockReflectivity = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockReflectivity.js"() {
    init_shaderStore();
    name5 = "pbrBlockReflectivity";
    shader5 = `struct reflectivityOutParams
...
var init_pbrBlockAmbientOcclusion = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockAmbientOcclusion.js"() {
    init_shaderStore();
    name6 = "pbrBlockAmbientOcclusion";
    shader6 = `struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
var init_pbrBlockAlphaFresnel = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockAlphaFresnel.js"() {
    init_shaderStore();
    name7 = "pbrBlockAlphaFresnel";
    shader7 = `#ifdef ALPHAFRESNEL
...
var init_pbrBlockAnisotropic = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockAnisotropic.js"() {
    init_shaderStore();
    name8 = "pbrBlockAnisotropic";
    shader8 = `#ifdef ANISOTROPIC
...
var init_pbrBlockSheen = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockSheen.js"() {
    init_shaderStore();
    name10 = "pbrBlockSheen";
    shader10 = `#ifdef SHEEN
...
var init_pbrBlockClearcoat = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockClearcoat.js"() {
    init_shaderStore();
    name11 = "pbrBlockClearcoat";
    shader11 = `struct clearcoatOutParams
...
var init_pbrBlockIridescence = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockIridescence.js"() {
    init_shaderStore();
    name12 = "pbrBlockIridescence";
    shader12 = `struct iridescenceOutParams
...
var init_pbrBlockSubSurface = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockSubSurface.js"() {
    init_shaderStore();
    name13 = "pbrBlockSubSurface";
    shader13 = `struct subSurfaceOutParams
...
var init_pbrBlockReflectance0 = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockReflectance0.js"() {
    init_shaderStore();
    name14 = "pbrBlockReflectance0";
    shader14 = `float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
...
var name15, shader15;
var init_pbrClusteredLightingFunctions = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrClusteredLightingFunctions.js"() {
    init_shaderStore();
    init_clusteredLightingFunctions();
    init_pbrBlockReflectance0();
    name15 = "pbrClusteredLightingFunctions";
    shader15 = `#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
var init_pbrBlockNormalFinal = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockNormalFinal.js"() {
    init_shaderStore();
    name16 = "pbrBlockNormalFinal";
    shader16 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
var init_pbrBlockLightmapInit = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockLightmapInit.js"() {
    init_shaderStore();
    name17 = "pbrBlockLightmapInit";
    shader17 = `#ifdef LIGHTMAP
...
var init_pbrBlockGeometryInfo = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockGeometryInfo.js"() {
    init_shaderStore();
    name18 = "pbrBlockGeometryInfo";
    shader18 = `float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
var init_pbrBlockReflectance = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockReflectance.js"() {
    init_shaderStore();
    name19 = "pbrBlockReflectance";
    shader19 = `#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
var init_pbrBlockDirectLighting = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockDirectLighting.js"() {
    init_shaderStore();
    name20 = "pbrBlockDirectLighting";
    shader20 = `vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
var init_pbrBlockFinalLitComponents = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockFinalLitComponents.js"() {
    init_shaderStore();
    name21 = "pbrBlockFinalLitComponents";
    shader21 = `aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
var init_pbrBlockFinalUnlitComponents = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockFinalUnlitComponents.js"() {
    init_shaderStore();
    name22 = "pbrBlockFinalUnlitComponents";
    shader22 = `vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
var init_pbrBlockFinalColorComposition = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockFinalColorComposition.js"() {
    init_shaderStore();
    name23 = "pbrBlockFinalColorComposition";
    shader23 = `vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
var name24, shader24, pbrPixelShader;
var init_pbr_fragment = __esm({
  "node_modules/@babylonjs/core/Shaders/pbr.fragment.js"() {
    ...
    init_pbrClusteredLightingFunctions();
    init_clipPlaneFragment();
    init_pbrBlockNormalGeometric();
    init_bumpFragment();
    ...
    init_oitFragment();
    init_pbrDebug();
    name24 = "pbrPixelShader";
    shader24 = `#define PBR_FRAGMENT_SHADER
...
`;
    ...
    pbrPixelShader = { name: name24, shader: shader24 };
  }
});
...
//# sourceMappingURL=chunk-CE52LJYG.js.map
