...
var name, shader, iblGenerateVoxelMipPixelShader;
var init_iblGenerateVoxelMip_fragment = __esm({
  "node_modules/@babylonjs/core/Shaders/iblGenerateVoxelMip.fragment.js"() {
    init_shaderStore();
    name = "iblGenerateVoxelMipPixelShader";
    shader = `precision highp float;precision highp sampler3D;varying vec2 vUV;uniform sampler3D srcMip;uniform int layerNum;void main(void) {ivec3 Coords=ivec3(2)*ivec3(gl_FragCoord.x,gl_FragCoord.y,layerNum);uint tex =
...
<< 7u;glFragColor.rgb=vec3(float(tex)/255.0f,0.0f,0.0f);glFragColor.a=1.0;}`;
    ...
    iblGenerateVoxelMipPixelShader = { name, shader };
  }
});
...
//# sourceMappingURL=chunk-WO7ABP7E.js.map
