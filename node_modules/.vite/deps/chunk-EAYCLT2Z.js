...
var name, shader, screenSpaceCurvaturePixelShader;
var init_screenSpaceCurvature_fragment = __esm({
  "node_modules/@babylonjs/core/Shaders/screenSpaceCurvature.fragment.js"() {
    init_shaderStore();
    name = "screenSpaceCurvaturePixelShader";
    shader = `precision highp float;varying vec2 vUV;uniform sampler2D textureSampler;uniform sampler2D normalSampler;uniform float curvature_ridge;uniform float curvature_valley;
...
{ivec2 texel=ivec2(gl_FragCoord.xy);vec4 baseColor=texture2D(textureSampler,vUV);float curvature=calculate_curvature(texel,curvature_ridge,curvature_valley);baseColor.rgb*=curvature+1.0;gl_FragColor=baseColor;}`;
    ...
    screenSpaceCurvaturePixelShader = { name, shader };
  }
});
...
//# sourceMappingURL=chunk-EAYCLT2Z.js.map
