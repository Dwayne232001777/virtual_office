...
} from "./chunk-LZQ2H4AJ.js";
import {
  init_morphTargetsVertexDeclaration
} from "./chunk-JSGK7STH.js";
import {
  init_morphTargetsVertexGlobal
} from "./chunk-APSZEATK.js";
import {
  init_morphTargetsVertex
} from "./chunk-BHPFZKGL.js";
import {
...
var name, shader;
var init_openpbrVertexDeclaration = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrVertexDeclaration.js"() {
    init_shaderStore();
    init_sceneVertexDeclaration();
    init_decalVertexDeclaration();
    name = "openpbrVertexDeclaration";
    shader = `#include<sceneVertexDeclaration>
#ifdef BASE_COLOR
...
var init_openpbrNormalMapVertexDeclaration = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrNormalMapVertexDeclaration.js"() {
    init_shaderStore();
    name2 = "openpbrNormalMapVertexDeclaration";
    shader2 = `#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
...
var init_openpbrNormalMapVertex = __esm({
  "node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrNormalMapVertex.js"() {
    init_shaderStore();
    name3 = "openpbrNormalMapVertex";
    shader3 = `#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
...
var name4, shader4, openpbrVertexShader;
var init_openpbr_vertex = __esm({
  "node_modules/@babylonjs/core/Shaders/openpbr.vertex.js"() {
    init_shaderStore();
    init_openpbrVertexDeclaration();
    init_openpbrUboDeclaration();
    init_uvAttributeDeclaration();
    init_mainUVVaryingDeclaration();
    init_helperFunctions();
    ...
    init_vertexColorMixing();
    init_logDepthVertex();
    name4 = "openpbrVertexShader";
    shader4 = `#define OPENPBR_VERTEX_SHADER
...
`;
    ...
    openpbrVertexShader = { name: name4, shader: shader4 };
  }
});
...
//# sourceMappingURL=chunk-J4D7RUPF.js.map
