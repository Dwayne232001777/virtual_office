...
var name, shader, depthOfFieldMergePixelShaderWGSL;
var init_depthOfFieldMerge_fragment = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/depthOfFieldMerge.fragment.js"() {
    init_shaderStore();
    name = "depthOfFieldMergePixelShader";
    shader = `varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;var circleOfConfusionSamplerSampler: sampler;var circleOfConfusionSampler: texture_2d<f32>;var blurStep0Sampler: sampler;var blurStep0: texture_2d<f32>;
#if BLUR_LEVEL>0
...
`;
    ...
    depthOfFieldMergePixelShaderWGSL = { name, shader };
  }
});
...
//# sourceMappingURL=chunk-IKBYIT4F.js.map
