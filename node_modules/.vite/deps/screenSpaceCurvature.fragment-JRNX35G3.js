...
var name, shader, screenSpaceCurvaturePixelShaderWGSL;
var init_screenSpaceCurvature_fragment = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/screenSpaceCurvature.fragment.js"() {
    init_shaderStore();
    name = "screenSpaceCurvaturePixelShader";
    shader = `varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;var normalSampler: texture_2d<f32>;uniform curvature_ridge: f32;uniform curvature_valley: f32;
...
`;
    ...
    screenSpaceCurvaturePixelShaderWGSL = { name, shader };
  }
});
...
//# sourceMappingURL=screenSpaceCurvature.fragment-JRNX35G3.js.map
