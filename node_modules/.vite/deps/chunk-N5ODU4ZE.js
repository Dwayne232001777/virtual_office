...
} from "./chunk-2WWUMUUF.js";
import {
  init_clusteredLightingFunctions
} from "./chunk-7KUCENZN.js";
import {
  ShaderStore,
  init_shaderStore
...
var init_subSurfaceScatteringFunctions = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/subSurfaceScatteringFunctions.js"() {
    init_shaderStore();
    name2 = "subSurfaceScatteringFunctions";
    shader2 = `fn testLightingForSSS(diffusionProfile: f32)->bool
...
var init_pbrHelperFunctions = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrHelperFunctions.js"() {
    init_shaderStore();
    name3 = "pbrHelperFunctions";
    shader3 = `#define MINIMUMVARIANCE 0.0005
...
var init_pbrDirectLightingSetupFunctions = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrDirectLightingSetupFunctions.js"() {
    init_shaderStore();
    init_ltcHelperFunctions();
    name4 = "pbrDirectLightingSetupFunctions";
    shader4 = `struct preLightingInfo
{lightOffset: vec3f,
...
var init_pbrDirectLightingFalloffFunctions = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrDirectLightingFalloffFunctions.js"() {
    init_shaderStore();
    name5 = "pbrDirectLightingFalloffFunctions";
    shader5 = `fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
var init_pbrBlockReflectance0 = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockReflectance0.js"() {
    init_shaderStore();
    name6 = "pbrBlockReflectance0";
    shader6 = `var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
var init_pbrDirectLightingFunctions = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrDirectLightingFunctions.js"() {
    ...
    name7 = "pbrDirectLightingFunctions";
    shader7 = `#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
var init_pbrIBLFunctions = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrIBLFunctions.js"() {
    init_shaderStore();
    name8 = "pbrIBLFunctions";
    shader8 = `#if defined(REFLECTION) || defined(SS_REFRACTION)
...
var init_pbrBlockNormalGeometric = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockNormalGeometric.js"() {
    init_shaderStore();
    name9 = "pbrBlockNormalGeometric";
    shader9 = `var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
var init_pbrBlockImageProcessing = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockImageProcessing.js"() {
    init_shaderStore();
    name10 = "pbrBlockImageProcessing";
    shader10 = `#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
var init_pbrBlockPrePass = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockPrePass.js"() {
    init_shaderStore();
    name11 = "pbrBlockPrePass";
    shader11 = `#if SCENE_MRT_COUNT>0
...
//# sourceMappingURL=chunk-N5ODU4ZE.js.map
