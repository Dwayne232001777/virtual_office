...
var name, shader, textureMergerPixelShaderWGSL;
var init_textureMerger_fragment = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/textureMerger.fragment.js"() {
    init_shaderStore();
    name = "textureMergerPixelShader";
    shader = `#ifdef USE_TEXTURE0
...
fragmentOutputs.color=vec4f(r,g,b,a);}`;
    ...
    textureMergerPixelShaderWGSL = { name, shader };
  }
});
init_textureMerger_fragment();
export {
  textureMergerPixelShaderWGSL
};
//# sourceMappingURL=textureMerger.fragment-Z7GJ4PBL.js.map
