...
} from "./chunk-C6AZDN5R.js";
import {
  init_decalFragment
} from "./chunk-UY5FAG5M.js";
import {
  init_instancesDeclaration
} from "./chunk-APPTLCU7.js";
import {
  init_bakedVertexAnimationDeclaration
} from "./chunk-TKN4TDRU.js";
import {
  init_bakedVertexAnimation
} from "./chunk-Y4O3OBFR.js";
import {
  init_instancesVertex
} from "./chunk-GUQ3UD7N.js";
import {
  ThinWebGPUEngine,
  WebGPUBundleList,
...
import {
  ...
  init_abstractEngine_textureLoaders,
  init_engine_common,
  init_math,
...
var init_webgpuShaderProcessor = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuShaderProcessor.js"() {
    WebGPUShaderProcessor = class _WebGPUShaderProcessor {
      constructor() {
...
var init_webgpuPipelineContext = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuPipelineContext.js"() {
    init_uniformBuffer();
    init_webgpuShaderProcessor();
    WebGPUPipelineContext = class {
...
var MaxGroups, MaxBindingsPerGroup, TypeToLocationSize, WebGPUShaderProcessingContext;
var init_webgpuShaderProcessingContext = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuShaderProcessingContext.js"() {
    MaxGroups = 4;
    MaxBindingsPerGroup = 1 << 16;
    TypeToLocationSize = {
      // GLSL types
      mat2: 2,
      mat3: 3,
    ...
    WebGPUShaderProcessingContext = class _WebGPUShaderProcessingContext {
...
var init_codeStringParsingTools = __esm({
  "node_modules/@babylonjs/core/Misc/codeStringParsingTools.js"() {
  }
});
...
var init_webgpuShaderProcessorsGLSL = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuShaderProcessorsGLSL.js"() {
    init_webgpuShaderProcessingContext();
    init_logger();
    init_webgpuShaderProcessor();
    init_codeStringParsingTools();
    WebGPUShaderProcessorGLSL = class extends WebGPUShaderProcessor {
      constructor() {
        super(...arguments);
...
var builtInName_frag_depth, leftOverVarName, internalsVarName, gpuTextureViewDimensionByWebGPUTextureFunction, WebGPUShaderProcessorWGSL;
var init_webgpuShaderProcessorsWGSL = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuShaderProcessorsWGSL.js"() {
    init_webgpuShaderProcessingContext();
    init_logger();
    init_webgpuShaderProcessor();
    ...
    init_sceneUboDeclaration();
    init_decalFragment();
    builtInName_frag_depth = "fragmentOutputs.fragDepth";
    leftOverVarName = "uniforms";
    internalsVarName = "internals";
    gpuTextureViewDimensionByWebGPUTextureFunction = {
      texture_1d: "1d",
      texture_2d: "2d",
    ...
    WebGPUShaderProcessorWGSL = class extends WebGPUShaderProcessor {
      constructor() {
        super(...arguments);
...
var init_webgpuHardwareTexture = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuHardwareTexture.js"() {
    init_math_scalar_functions();
    init_webgpuTextureHelper();
    WebGPUHardwareTexture = class {
...
var init_webgpuTextureManager = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuTextureManager.js"() {
    ...
    `;
    invertYPreMultiplyAlphaWithOfstVertexSource = invertYPreMultiplyAlphaVertexSource;
    invertYPreMultiplyAlphaWithOfstFragmentSource = `
    var img: texture_2d<f32>;
    uniform ofstX: f32;
    uniform ofstY: f32;
    uniform width: f32;
    ...
    `;
    copyVideoToTextureVertexSource = `
    struct VertexOutput {
        @builtin(position) Position : vec4<f32>,
    ...
    `;
    copyVideoToTextureFragmentSource = `
    ...
    `;
    copyVideoToTextureInvertYFragmentSource = `
    @group(0) @binding(0) var videoSampler: sampler;
    @group(0) @binding(1) var videoTexture: texture_external;
...
var WebGPUDataBuffer;
var init_webgpuDataBuffer = __esm({
  "node_modules/@babylonjs/core/Meshes/WebGPU/webgpuDataBuffer.js"() {
    init_dataBuffer();
    WebGPUDataBuffer = class extends DataBuffer {
      set buffer(buffer) {
        this._buffer = buffer;
      }
...
var init_webgpuBufferManager = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuBufferManager.js"() {
    init_webgpuDataBuffer();
    init_textureTools();
    init_abstractEngine_functions();
    init_webgpuConstants();
    WebGPUBufferManager = class _WebGPUBufferManager {
...
var FilterToBits, ComparisonFunctionToBits, FilterNoMipToBits, WebGPUCacheSampler;
var init_webgpuCacheSampler = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuCacheSampler.js"() {
    FilterToBits = [
      0 | 0 << 1 | 0 << 2,
      // not used
    ...
    WebGPUCacheSampler = class _WebGPUCacheSampler {
      constructor(device) {
        this._samplers = {};
        this._device = device;
        this.disabled = false;
...
var init_buffer_nonFloatVertexBuffers = __esm({
  "node_modules/@babylonjs/core/Buffers/buffer.nonFloatVertexBuffers.js"() {
    init_buffer2();
    VertexBufferKindForNonFloatProcessing = {
...
var StatePosition, alphaBlendFactorToIndex, alphaBlendEquationToIndex, stencilOpToIndex, colorStates, WebGPUCacheRenderPipeline;
var init_webgpuCacheRenderPipeline = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuCacheRenderPipeline.js"() {
    init_buffer();
    init_webgpuTextureHelper();
    ...
    colorStates = [0, 0, 0, 0];
    WebGPUCacheRenderPipeline = class _WebGPUCacheRenderPipeline {
...
var NodeState, WebGPUCacheRenderPipelineTree;
var init_webgpuCacheRenderPipelineTree = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuCacheRenderPipelineTree.js"() {
    init_webgpuCacheRenderPipeline();
    NodeState = class {
      constructor() {
        this.values = {};
      }
    ...
    WebGPUCacheRenderPipelineTree = class _WebGPUCacheRenderPipelineTree extends WebGPUCacheRenderPipeline {
...
var init_webgpuStencilStateComposer = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuStencilStateComposer.js"() {
    init_stencilStateComposer();
    WebGPUStencilStateComposer = class extends StencilStateComposer {
      constructor(cache) {
        super(false);
        this._cache = cache;
        this.reset();
...
var WebGPUDepthCullingState;
var init_webgpuDepthCullingState = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuDepthCullingState.js"() {
    init_depthCullingState();
    WebGPUDepthCullingState = class extends DepthCullingState {
      /**
...
var ExternalTexture;
var init_externalTexture = __esm({
  "node_modules/@babylonjs/core/Materials/Textures/externalTexture.js"() {
    init_internalTexture();
...
var init_webgpuMaterialContext = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuMaterialContext.js"() {
    init_externalTexture();
    init_webgpuCacheSampler();
    WebGPUMaterialContext = class _WebGPUMaterialContext {
...
var init_webgpuDrawContext = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuDrawContext.js"() {
    init_webgpuConstants();
    WebGPUDrawContext = class _WebGPUDrawContext {
      /**
...
var BufferIdStart, TextureIdStart, WebGPUBindGroupCacheNode, WebGPUCacheBindGroups;
var init_webgpuCacheBindGroups = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuCacheBindGroups.js"() {
    init_logger();
    BufferIdStart = 1 << 20;
    TextureIdStart = 2 ** 35;
    WebGPUBindGroupCacheNode = class {
      constructor() {
        this.values = {};
      }
    };
    WebGPUCacheBindGroups = class _WebGPUCacheBindGroups {
...
var name, shader;
var init_clearQuad_vertex = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/clearQuad.vertex.js"() {
    init_shaderStore();
    name = "clearQuadVertexShader";
    shader = `uniform depthValue: f32;const pos=array(
vec2f(-1.0,1.0),
vec2f(1.0,1.0),
vec2f(-1.0,-1.0),
vec2f(1.0,-1.0)
...
var name2, shader2;
var init_clearQuad_fragment = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/clearQuad.fragment.js"() {
    init_shaderStore();
    name2 = "clearQuadPixelShader";
    shader2 = `uniform color: vec4f;@fragment
...
var WebGPUClearQuad;
var init_webgpuClearQuad = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuClearQuad.js"() {
    init_webgpuCacheRenderPipelineTree();
    init_webgpuShaderProcessingContext();
    init_webgpuTextureHelper();
    init_webgpuTextureManager();
    init_clearQuad_vertex();
    init_clearQuad_fragment();
    WebGPUClearQuad = class {
      setDepthStencilFormat(format) {
...
var WebGPUQuerySet;
var init_webgpuQuerySet = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuQuerySet.js"() {
    init_webgpuConstants();
    WebGPUQuerySet = class {
      get querySet() {
...
var WebGPUTimestampQuery, WebGPUDurationMeasure;
var init_webgpuTimestampQuery = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuTimestampQuery.js"() {
    init_perfCounter();
    init_webgpuQuerySet();
    init_logger();
    WebGPUTimestampQuery = class {
...
var init_webgpuOcclusionQuery = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuOcclusionQuery.js"() {
    init_webgpuQuerySet();
    WebGPUOcclusionQuery = class {
      get querySet() {
...
var init_shaderCodeInliner = __esm({
  "node_modules/@babylonjs/core/Engines/Processors/shaderCodeInliner.js"() {
    init_logger();
    init_codeStringParsingTools();
    ShaderCodeInliner = class _ShaderCodeInliner {
...
var WebGPUTintWASM;
var init_webgpuTintWASM = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuTintWASM.js"() {
    init_logger();
    init_tools();
    WebGPUTintWASM = class _WebGPUTintWASM {
...
var init_webgpuSnapshotRendering = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuSnapshotRendering.js"() {
    init_logger();
    WebGPUSnapshotRendering = class {
...
var Instances, AudioEngineV2;
var init_audioEngineV2 = __esm({
  "node_modules/@babylonjs/core/AudioV2/abstractAudio/audioEngineV2.js"() {
    Instances = [];
    AudioEngineV2 = class {
      constructor(options) {
...
var _SpatialAudioListenerDefaults, AbstractSpatialAudioListener;
var init_abstractSpatialAudioListener = __esm({
  "node_modules/@babylonjs/core/AudioV2/abstractAudio/subProperties/abstractSpatialAudioListener.js"() {
    init_math_vector();
    ...
    AbstractSpatialAudioListener = class {
    };
  }
});

// node_modules/@babylonjs/core/AudioV2/abstractAudio/subProperties/spatialAudioListener.js
var _SpatialAudioListener;
var init_spatialAudioListener = __esm({
  "node_modules/@babylonjs/core/AudioV2/abstractAudio/subProperties/spatialAudioListener.js"() {
    init_spatialAudioAttacherComponent();
    init_abstractSpatialAudioListener();
    _SpatialAudioListener = class extends AbstractSpatialAudioListener {
      constructor() {
        super();
...
var TmpMatrix, TmpQuaternion, TmpVector1, TmpVector2, _AbstractSpatialWebAudioListener, _SpatialWebAudioListener, _SpatialWebAudioListenerFallback;
var init_spatialWebAudioListener = __esm({
  "node_modules/@babylonjs/core/AudioV2/webAudio/subProperties/spatialWebAudioListener.js"() {
    init_math_vector();
    init_spatialAudioListener();
    init_spatialWebAudioUpdaterComponent();
    init_webAudioParameterComponent();
    TmpMatrix = Matrix.Zero();
    TmpQuaternion = new Quaternion();
    TmpVector1 = Vector3.Zero();
    TmpVector2 = Vector3.Zero();
    _AbstractSpatialWebAudioListener = class extends _SpatialAudioListener {
      /** @internal */
    ...
    _SpatialWebAudioListener = class extends _AbstractSpatialWebAudioListener {
      constructor(engine, autoUpdate, minUpdateTime) {
    ...
    _SpatialWebAudioListenerFallback = class extends _AbstractSpatialWebAudioListener {
      _setWebAudioPosition(position) {
...
var _MainAudioOut;
var init_mainAudioOut = __esm({
  "node_modules/@babylonjs/core/AudioV2/abstractAudio/mainAudioOut.js"() {
    init_abstractAudioNode();
    _MainAudioOut = class extends AbstractAudioNode {
      constructor(engine) {
        super(
          engine,
          1
...
var _WebAudioMainOut;
var init_webAudioMainOut = __esm({
  "node_modules/@babylonjs/core/AudioV2/webAudio/webAudioMainOut.js"() {
    init_mainAudioOut();
    init_webAudioParameterComponent();
    _WebAudioMainOut = class extends _MainAudioOut {
      /** @internal */
      constructor(engine) {
        super(engine);
...
var _WebAudioUnmuteUI;
var init_webAudioUnmuteUI = __esm({
  "node_modules/@babylonjs/core/AudioV2/webAudio/webAudioUnmuteUI.js"() {
    init_engineStore();
    _WebAudioUnmuteUI = class {
      /** @internal */
...
var FormatMimeTypes, _WebAudioEngine;
var init_webAudioEngine = __esm({
  "node_modules/@babylonjs/core/AudioV2/webAudio/webAudioEngine.js"() {
    init_observable();
    init_audioEngineV2();
    init_abstractSpatialAudioListener();
    init_spatialWebAudioListener();
    init_webAudioMainOut();
    init_webAudioUnmuteUI();
    FormatMimeTypes = {
      aac: "audio/aac",
      ac3: "audio/ac3",
      flac: "audio/flac",
    ...
    _WebAudioEngine = class extends AudioEngineV2 {
      /** @internal */
      constructor(options = {}) {
        super(options);
      ...
      async createBusAsync(name3, options = {}) {
        const module = await import("./webAudioBus-RHKFU6PB.js");
      ...
      async createMainBusAsync(name3, options = {}) {
        const module = await import("./webAudioMainBus-H5ETHXQK.js");
      ...
      async createSoundAsync(name3, source, options = {}) {
        const module = await import("./webAudioStaticSound-GZXUANFV.js");
      ...
      async createSoundSourceAsync(name3, source, options = {}) {
        const module = await import("./webAudioSoundSource-C2MKTQDB.js");
      ...
      async createStreamingSoundAsync(name3, source, options = {}) {
        const module = await import("./webAudioStreamingSound-UJUJYRN7.js");
...
var init_webgpuExternalTexture = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuExternalTexture.js"() {
    init_externalTexture();
    WebGPUExternalTexture = class extends ExternalTexture {
      constructor(video) {
        super(video);
      }
    };
...
var WebGPURenderTargetWrapper;
var init_webgpuRenderTargetWrapper = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/webgpuRenderTargetWrapper.js"() {
    init_renderTargetWrapper();
    init_webgpuPerfCounter();
    WebGPURenderTargetWrapper = class extends RenderTargetWrapper {
      /**
...
var init_engine_renderTarget = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/Extensions/engine.renderTarget.js"() {
    init_internalTexture();
    init_webgpuRenderTargetWrapper();
    init_textureHelper_functions();
    init_abstractEngine_texture();
    init_thinWebGPUEngine();
...
var ViewDescriptorSwapChainAntialiasing, ViewDescriptorSwapChain, TempColor4, WebGPUEngine;
var init_webgpuEngine = __esm({
  "node_modules/@babylonjs/core/Engines/webgpuEngine.js"() {
    init_logger();
    init_thinWebGPUEngine();
    init_math();
    ...
    init_webgpuShaderProcessorsGLSL();
    init_webgpuShaderProcessorsWGSL();
    init_webgpuShaderProcessingContext();
    init_tools();
    init_webgpuTextureHelper();
    init_webgpuTextureManager();
    ...
    init_webgpuCacheSampler();
    init_webgpuCacheRenderPipelineTree();
    init_webgpuStencilStateComposer();
    init_webgpuDepthCullingState();
    init_webgpuMaterialContext();
    init_webgpuDrawContext();
    init_webgpuCacheBindGroups();
    init_webgpuClearQuad();
    init_webgpuBundleList();
    init_webgpuTimestampQuery();
    init_webgpuOcclusionQuery();
    init_shaderCodeInliner();
    init_webgpuTintWASM();
    init_webgpuShaderProcessor();
    init_webgpuSnapshotRendering();
    init_alphaCullingState();
    init_buffer_align();
    init_sphericalPolynomial();
    init_performanceMonitor();
    ...
    TempColor4 = new Color4();
    WebGPUEngine = class _WebGPUEngine extends ThinWebGPUEngine {
      /**
...
var init_engine_multiRender = __esm({
  "node_modules/@babylonjs/core/Engines/WebGPU/Extensions/engine.multiRender.js"() {
    init_internalTexture();
    init_logger();
    init_webgpuEngine();
...
//# sourceMappingURL=chunk-4GRHQQVJ.js.map
