...
var name, shader, iblShadowDebugPixelShaderWGSL;
var init_iblShadowDebug_fragment = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/iblShadowDebug.fragment.js"() {
    init_shaderStore();
    name = "iblShadowDebugPixelShader";
    shader = `varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;var debugSamplerSampler: sampler;var debugSampler: texture_2d<f32>;uniform sizeParams: vec4f;
...
vec2f((offsetX+fragmentInputs.vUV.x)*widthScale,(offsetY+fragmentInputs.vUV.y)*heightScale);var background: vec4f=textureSample(textureSampler,textureSamplerSampler,fragmentInputs.vUV);var debugColour: vec4f=textureSample(debugSampler,debugSamplerSampler,fragmentInputs.vUV);if (uv.x<0.0 || uv.x>1.0 || uv.y<0.0 || uv.y>1.0) {fragmentOutputs.color=background;} else {fragmentOutputs.color=vec4f(mix(debugColour.rgb,background.rgb,0.0),1.0);}}`;
    ...
    iblShadowDebugPixelShaderWGSL = { name, shader };
  }
});

export {
  iblShadowDebugPixelShaderWGSL,
  init_iblShadowDebug_fragment
};
//# sourceMappingURL=chunk-LASI4XNN.js.map
