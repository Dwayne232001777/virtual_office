    ...
    RGBDTextureTools = class {
      ...
      static ExpandRGBDTexture(texture) {
        ...
        const expandRgbdTextureAsync = async () => {
          ...
          internalTexture.isReady = false;
          if (isWebGpu) {
            await import("./rgbdDecode.fragment-PIC3ZCPS.js");
          } else {
            await import("./rgbdDecode.fragment-5BKJNPOW.js");
          }
      ...
      static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
        if (!scene.getEngine().isWebGPU) {
          await import("./rgbdEncode.fragment-H6Z72MD4.js");
        } else {
          await import("./rgbdEncode.fragment-LDNVDMCE.js");
        }
...
//# sourceMappingURL=chunk-ESGOHTGL.js.map
