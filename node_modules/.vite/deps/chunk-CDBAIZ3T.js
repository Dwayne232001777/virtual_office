...
var name, shader, iblVoxelGridPixelShaderWGSL;
var init_iblVoxelGrid_fragment = __esm({
  "node_modules/@babylonjs/core/ShadersWGSL/iblVoxelGrid.fragment.js"() {
    init_shaderStore();
    name = "iblVoxelGridPixelShader";
    shader = `var voxel_storage: texture_storage_3d<rgba8unorm,write>;varying vNormalizedPosition: vec3f;flat varying f_swizzle: i32;@fragment
...
textureStore(voxel_storage,vec3<i32>(i32(normPos.x*size.x),i32(normPos.y*size.y),i32(normPos.z*size.z)),outputColor);fragmentOutputs.color=vec4<f32>(vec3<f32>(normPos),1.);}`;
    ...
    iblVoxelGridPixelShaderWGSL = { name, shader };
  }
});
...
//# sourceMappingURL=chunk-CDBAIZ3T.js.map
