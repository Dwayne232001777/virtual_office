...
const scrollToItemDynamic = (params)=>{
    const { index, getItemSize, totalSize, scrollViewRef, axis = 'vertical', reversed = false, behavior = 'auto', gap = 0 } = params;
    let itemDepth = 0;
...
//# sourceMappingURL=imperativeScrollingDynamic.js.map